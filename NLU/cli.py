...
def load_pet_configs(args) -> Tuple[WrapperConfig, TrainConfig, EvalConfig]:
    ...
    model_cfg = WrapperConfig(model_type=args.model_type,
                              ...
                              prompt_head_size=args.prompt_head_size,
...
def main():
    ...
    parser.add_argument("--pet_num_train_epochs", default=5, type=float,
    ...
    parser.add_argument('--prompt_encoder_type', type=str, default="mlp", choices=['lstm', 'mlp'])
    parser.add_argument("--eval_every_step", default=20, type=int, help="")
    parser.add_argument("--prompt_tuning", action='store_true', help="Whether only tuning the prompt")
    parser.add_argument("--prompt_length", default=16,type=int, help="the prompt length to use")
    parser.add_argument("--prompt_head_size", default=64, help="the query and the key to project")
    ...
    train_pet(train_data=train_data,
                  eval_data=eval_data,
